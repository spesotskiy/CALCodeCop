...
Style checks for Dynamics NAV 2017 (C/AL) object text exports. This slice parses a codeunit and runs Rule 001 (operator and comma spacing), Rule 002 (unary operator spacing), and Rule 003 (index and option-access spacing).
